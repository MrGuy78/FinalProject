...
export class SocialGroupService {
  ...
  ownedGroups(): Observable<SocialGroup[]> {
    return this.http
      .get<SocialGroup[]>(this.url + '/owned', this.getHttpOptions())
      .pipe(
        catchError((err: any) => {
          console.log(err);
          return throwError(
  ...
  joinedGroups(): Observable<SocialGroup[]> {
    return this.http
      .get<SocialGroup[]>(this.url + '/joined', this.getHttpOptions())
      .pipe(
        catchError((err: any) => {
          console.log(err);
          return throwError(
  ...
  show(groupId: number): Observable<SocialGroup> {
    return this.http
      .get<SocialGroup>(this.url + '/' + groupId, this.getHttpOptions())
      .pipe(
        catchError((err: any) => {
          console.log(err);
          return throwError(
            () =>
              new Error(
                'GroupService.show(): error retrieving group with id:' + err
              )
          );
        })
      );
  ...
  create(socialGroup: SocialGroup): Observable<SocialGroup> {
    ...
    return this.http
      .post<SocialGroup>(this.url, socialGroup, this.getHttpOptions())
      .pipe(
      ...
      .pipe(
        catchError((error: any) => {
          ...
          return throwError(
            () =>
              new Error(
                'SocialGroupService.update(): error updating group: ' +
                  error.message
              )
          );
        })
      ...
      .pipe(
        catchError((error: any) => {
          ...
          return throwError(
            () =>
              new Error(
                'SocialGroupService.newMember(): error adding groupMember: ' +
                  error.message
              )
          );
        })
  ...
  filterGroupsByCategory(categoryId: number): Observable<SocialGroup[]> {
    return this.http
      .get<SocialGroup[]>(this.url + '/categories/' + categoryId)
      .pipe(
        catchError((error: any) => {
          console.log(error);
          return throwError(
            () =>
              new Error(
                'SocialGroupService.filterGroupsByCategory(): error filtering by category: ' +
                  error.message
              )
          );
        })
