...
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (20, 'Dog Meetup at Dry Creek Park', 'Just a short meetup to let the pups run around and play. Bring a leash since you will need it to get to the dog area, but can take it off once you let them in.', '2025-3-22 9:00:00', '9:00:00', '11:00:00', NULL, NULL, NULL, NULL, 1, 2, 11, 11, 11, 11);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (21, 'Westminster Dog Meetup', 'We are going to have lunch and let the pups play and have fun. We will have a dog trainer there to talk to us about obedience school and they have a discount for our group.', '2025-4-16 10:00:00', '10:00:00', '12:00:00', NULL, NULL, NULL, NULL, 1, 2, 11, 11, 11, 11);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (22, 'Yoga at the Studio', 'Meet at the studio for a relaxing session.', '2025-3-26 7:00:00', '7:00:00', '8:00:00', NULL, NULL, NULL, NULL, 1, 1, 12, 12, 12, 12);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (23, 'Yoga at the Outdoor Pool', 'Meet at the Clyde rec center. We were able to reserve the pool before it opens to the public. Watch the sunrise with us.', '2025-4-26 7:00:00', '7:00:00', '8:00:00', NULL, NULL, NULL, NULL, 1, 1, 12, 12, 12, 12);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (24, 'Yoga in the Park', 'We will meet at the Centennial Park just before sun rise to greet the new day with a great session of core yoga.', '2025-5-9 7:00:00', '7:00:00', '8:00:00', NULL, NULL, NULL, NULL, 1, 1, 12, 12, 12, 12);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (25, 'Restaurant Hopping Friday', 'We will be starting at Tsunami for sushi, going over to R&R for some BBQ, and then finishing the night at Keys on Main for drinks.', '2025-5-14 5:30:00', '5:30:00', '9:00:00', NULL, NULL, NULL, NULL, 1, 1, 13, 13, 13, 13);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (26, 'Harmons Cooking Class', 'They will be teaching how to make carne asada tacos with all of the fixins.', '2025-6-2 5:30:00', '5:30:00', '8:30:00', NULL, NULL, NULL, NULL, 1, 1, 13, 13, 13, 13);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (27, 'Dutch Oven Baking', 'Learn how to make chicken and dumplings and peach cobbler with a Dutch overn expert.', '2025-7-26 5:30:00', '5:30:00', '8:00:00', NULL, NULL, NULL, NULL, 1, 1, 13, 13, 13, 13);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (28, 'Monthly Food Drive', 'This is an ongoing monthly event where we go around and collect donated food and bring it to the pantry.', '2025-3-21 11:30:00', '11:30:00', '1:00:00', NULL, NULL, NULL, NULL, 1, 2, 14, 14, 14, 14);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (29, 'Feed the Homeless', 'We will be serving dinner at the Pantry for those in need. Come and serve!', '2025-4-4 5:30:00', '5:30:00', '7:30:00', NULL, NULL, NULL, NULL, 1, 2, 14, 14, 14, 14);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (30, 'Clean Up Main Street', 'We will meet early Saturday morning to pick up trash along Main Street. ', '2025-5-6 8:30:00', '8:30:00', '10:30:00', NULL, NULL, NULL, NULL, 1, 2, 14, 14, 14, 14);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (31, 'Harry Potter Discussion', 'We will be discussing book 5 so hopefully you have finished it. If not, get to it and we will talk about the plot twist at the end!', '2025-4-6 6:30:00', '6:30:00', '8:00:00', NULL, NULL, NULL, NULL, 1, 1, 15, 15, 15, 15);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (32, 'Next Book Planning Meeting', 'We will be calendaring our next 4 books that we want to read by taking suggestions and voting.', '2025-6-9 6:30:00', '6:30:00', '8:00:00', NULL, NULL, NULL, NULL, 1, 1, 15, 15, 15, 15);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (33, 'Fly Fishing Meetup', 'We will meet at Harmons and head up to the Provo river for fly fishing. There is cell service in the canyon if you are late you can still come up and join us.', '2025-5-21 7:30:00', '7:30:00', '2:00:00', NULL, NULL, NULL, NULL, 1, 1, 16, 16, 16, 16);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (34, 'Fly Tying Night', 'Come and bring your fly tying gear and we will help you build a few and share fish stories.', '2025-6-18 7:00:00', '7:00:00', '8:30:00', NULL, NULL, NULL, NULL, 1, 1, 16, 16, 16, 16);
INSERT INTO `social_event` (`id`, `title`, `description`, `event_date`, `start_time`, `end_time`, `image_url`, `create_date`, `last_update`, `cost`, `enabled`, `member_only`, `meet_address_id`, `event_address_id`, `social_group_id`, `user_id`) VALUES (35, 'Planning Trip to the Snake River', 'We are planning our big trip up to the Snake River in June.', '2025-5-9 5:30:00', '5:30:00', '7:00:00', NULL, NULL, NULL, NULL, 1, 1, 17, 17, 17, 17);
